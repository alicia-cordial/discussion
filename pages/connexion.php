    ...
    <form class="col s12" action="connexion.php" method="post">
      <div class="row">
        <div class="input-field col s12">
          <input placeholder="login" id="loginconnect" type="text" name="loginconnect" class="validate white-text" required/>
          <label for="login">Login</label>
        </div>
      </div>
      <div class="row">
        <div class="input-field col s12">
          <input id="passwordconnect" type="password" class="validate white-text" name="passwordconnect" required/>
