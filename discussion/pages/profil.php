...
$user = $requser->fetch();
$username=$_POST['newlogin'];

    if(isset($_POST['newlogin'])){
    $requser = $bdd->prepare("SELECT COUNT(*) FROM utilisateurs WHERE login = ?");
    $requserlogin->execute(array($username));
    $userlogin = $requser->fetch();
    }

        if($userlogin!=0){

            if(!empty($_POST['newlogin']) AND $_POST['newlogin'] != $user['login']) {
  ...
  <form class="col s12" action="profil.php" method="post" enctype="multipart/form-data">
    <div class="row">
        <div class="input-field col s12">
          <input placeholder="newlogin" id="newlogin" type="text" name="newlogin" data-length="20" class="validate white-text" value="<?php echo $user['login']; ?>"/>
    ...
    <div class="row">
        <div class="input-field col s12">
          <input id="newpassword" type="password" class="validate white-text" name="newpassword" data-length="10"/>
    ...
    <div class="row">
      <div class="input-field col s12">
          <input id="newpassword2" type="password" class="validate white-text" name="newpassword2" data-length="10"/>
